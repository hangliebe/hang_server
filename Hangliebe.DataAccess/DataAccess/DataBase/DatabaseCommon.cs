using Hangliebe.DataAccess.Attributes;
using System;
...
namespace Hangliebe.DataAccess
{
    public class DatabaseCommon
    {
        ...
        {
            Assembly asmb = Assembly.LoadFrom(System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "bin", "Hangliebe.Entity.dll"));
