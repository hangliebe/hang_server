...
using Hangliebe.DataAccess.Common;


/// <summary>
/// DbHelperSQL 的摘要说明
/// </summary>
namespace Hangliebe.DataAccess
{
    public abstract class DbHelperSQL
    {
        //protected static string connectionString = "Server=.;Initial Catalog=ZTFramework;User ID=sa;Password=sa123";
        protected static string connectionString = "Server=192.168.1.3;Initial Catalog=JAC_FrontAxle;User ID=sa;Password=sa";
