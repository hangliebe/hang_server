...
badd +0 hang_server/Controllers/AudioController.cs
badd +0 AudioModule/AudioTool.cs
argglobal
%argdel
$argadd hang_server/Controllers/AudioController.cs
set stal=2
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit hang_server/Controllers/AudioController.cs
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
normal! 0
tabnext
edit AudioModule/AudioTool.cs
argglobal
balt hang_server/Controllers/AudioController.cs
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
